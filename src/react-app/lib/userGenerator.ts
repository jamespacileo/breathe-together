...
const NAME_POOL: string[] = [
  // Nature-inspired
  'River', 'Sage', 'Sky', 'Ocean', 'Rain', 'Storm', 'Leaf', 'Brook', 'Meadow', 'Dawn',
  // Classic unisex
  'Alex', 'Sam', 'Jordan', 'Taylor', 'Casey', 'Morgan', 'Riley', 'Quinn', 'Avery', 'Cameron',
  // Modern
  'Kai', 'Nova', 'Luna', 'Aria', 'Rowan', 'Eden', 'Phoenix', 'Ember', 'Willow', 'Ash',
  // Traditional
  'Jamie', 'Drew', 'Blake', 'Reese', 'Charlie', 'Finley', 'Hayden', 'Emery', 'Jules', 'Kit',
  // Short & warm
  'Max', 'Leo', 'Ava', 'Mia', 'Eli', 'Ivy', 'Zoe', 'Lux', 'Ren', 'Sol',
];
