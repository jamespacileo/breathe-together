 ...
 */
export const MOOD_IDS = ['moment', 'anxious', 'processing', 'preparing', 'grateful', 'celebrating', 'here'] as const;
 ...
 */
export function normalizeMoodDistribution(dist: MoodDistribution): MoodDistribution {
